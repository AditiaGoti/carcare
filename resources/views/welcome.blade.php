    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>On this website you can make reservations to deposit your car. on this website you can also do maintenance for your car at the same time</h2>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="{{asset('/img/Car_care__2.png')}}" data-aos="zoom-in" data-aos-delay="150" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            <h3>Why CarCare Is The Best Choice?</h3>
            <p  style="color: white;" class="fst-italic">
              because car care can help customers who like to leave their vehicles for a long period of time and the customer's vehicle will be maintained and will be kept safe
            </p>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <p>Dengan berlangganan akun premium anda dapat menikmati banyak layanan yang telah disediakan</p>
            </div>
          </div>
          <div class="row justify-content-center" style="margin-top: 30px;">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="icon-box">
                ...
                <p>Dengan menggunakan CarCare anda bisa mencari lokasi penetipan terdekat dengan Anda</p>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
              <div class="icon-box">
                ...
                <p>Pada CarCare anda mendapatkan jaminan untuk kemanan kendaraan anda. Anda bisa melihat kondisi kendaraan anda dari jauh.</p>
              </div>
            </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            ...
            <h2 style="color: white;">Car Care is a website that provides services for leaving vehicles when users want to leave their vehicles for a long period of time.
            </h2>
